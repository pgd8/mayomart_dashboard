...
class _EditOfferFormState extends State<EditOfferForm> {
          ...
          Container(
            ...
            child: ElevatedButton(
                  ...
                  if (formKey.currentState!.validate()) {
                    if (ConnectionState == ConnectionState.waiting) {
                      ...
                      showMessage(context, AppLocalizations.of(context)!.done,
                          AppLocalizations.of(context)!.offerUpdated, () {
                        hideAlert(context);
                        clearData();
                        setState(() {});
                      },
                ...
                child: ButtonLabel(
                  ...
                  label: AppLocalizations.of(context)!.updateOffer,
                )),
          ),
        ],
      ),
  ...
  void getData() {
    titleCon.text = widget.offer.title;
    descriptionCon.text = widget.offer.description;
    imagePathCon.text = widget.offer.imagePath;
  }
