...
class EditRecommendedForm extends StatefulWidget {
  final RecommendedDataClass recommended;

  const EditRecommendedForm({super.key, required this.recommended});

  @override
  State<EditRecommendedForm> createState() => _EditRecommendedFormState();
}

class _EditRecommendedFormState extends State<EditRecommendedForm> {
          ...
          Container(
            ...
            child: ElevatedButton(
                ...
                child: ButtonLabel(
                  ...
                  label: AppLocalizations.of(context)!.updateRecommended,
                )),
          ),
        ],
      ),
  ...
  void getData() {
    titleCon.text = widget.recommended.title;
    descriptionCon.text = widget.recommended.description;
    imagePathCon.text = widget.recommended.imagePath;
  }
