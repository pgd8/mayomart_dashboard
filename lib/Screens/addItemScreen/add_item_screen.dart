                    ...
                    child: ElevatedButton(
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            firebaseFunctions.addProductToFireStore(
                                ProductDataClass(
                                    ...
                                    productStock:
                                        productQuantityInStockCon.hashCode,
                                    productPrice: productPriceCon.hashCode,
                                    maxQuantity: productMaxQuantityCon.hashCode,
                                    minQuantity:
                                        productMinimumQuantityCon.hashCode));
                          }
                        },
                        child: ButtonLabel(
